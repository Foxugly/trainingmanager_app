...
class AuthRepository(
    ...
    suspend fun listEvents(dateGte: String? = null, dateLte: String? = null, referProgram: Int? = null) =
        api.listEvents(dateGte = dateGte, dateLte = dateLte, referProgram = referProgram)
